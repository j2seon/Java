...
public class ScannerEx {
	public static void main(String[] args) {
		...
		double weight = scanner.nextDouble();  //실수 값을 인풋 받아서 읽어 드림 
		System.out.println("체중은" + weight + ", ");
		
		boolean single = scanner.nextBoolean(); //true or false(논리값을 읽어 들임)
		System.out.println("독신여부는 " + single + "입니다. ");
		scanner.close(); //끝났으면 반드시 close를 해야한다.
	}
}
